...
import type { PromptEffectivenessRow } from "@/lib/sheets";
    ...
    return (
      <Card className="border-0 shadow-xl bg-card/50 backdrop-blur-sm">
        ...
        <CardContent className="text-sm text-muted-foreground">
          Google Sheets submissions must include columns for facilitator, spark, or signal prompt usefulness (1-5 scale) for this view to populate.
        </CardContent>
      </Card>
    );
  }
            ...
            <div className="flex-1 space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Scores reflect average usefulness ratings synced from Google Sheets. Use higher-scoring prompt types to reinfo
rce each segment.
                </p>
              </div>
              <div>
